...
class MyItemCatalyst(var id: Int,
    ...
    fun countPricePln() : Float{
        ...
        val pricePlatinum : Float = this.countPriceElement(this.platinum, this.weight, courseUsdPln,
        ...
        val pricePalladium : Float = this.countPriceElement(this.palladium, this.weight, courseUsdPln,
        ...
        var priceRhodium : Float = this.countPriceElement(this.rhodium,this.weight, courseUsdPln,
